    ...
    public void pronunciationBtnClick(ImageView pronunciationBtn){
        pronunciationBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MediaPlayer sound = getPronunciation(array.pronunciation16);
                soundPlay(sound);
            }
        });
    }
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (count == 10) {
                ...
                getImages(imageLUp, imageRUp, imageLLow, imageRLow, textLUp, textRUp, textLLow, textRLow,
                        array.images16, array.texts16_2);
                ...
                //Определяем спрашиваемое слово на английском
                getWordEnglish(numLeftUpper, numLeftLower, numRightUpper, numRightLower, text, array.texts16_1);
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        closeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level16.this, Levels.class);
        ...
        getImages(img_left_upper, img_right_upper, img_left_lower, img_right_lower, text_left_upper,
                text_right_upper, text_left_lower, text_right_lower, array.images16, array.texts16_2);
